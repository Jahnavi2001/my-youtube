...
export const CHANNEL_LIST_API = 'https://youtube.googleapis.com/youtube/v3/channels?part=snippet%2CcontentDetails%2Cstatistics&key=' + YOUTUBE_API_KEY + '&id='

export const YOUTUBE_SEARCH_SUGGESTIONS_API = 'http://suggestqueries.google.com/complete/search?client=firefox&ds=yt&q='

export const YOUTUBE_SEARCH_LIST_API = 'https://youtube.googleapis.com/youtube/v3/search?part=snippet&key=' + YOUTUBE_API_KEY + '&q='
